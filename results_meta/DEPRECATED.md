...
- `results/bunny_force_visualization/INDEX.txt`
...
- `results/robot_deformable_demo/BEST_RUN.txt`
- `results/robot_deformable_demo/LEGACY_CANDIDATES.txt`
- `results/native_robot_rope_drop_release/README.md`
- `results/native_robot_rope_drop_release/BEST_RUN.txt`
...
- `results/rope_perf_apples_to_apples/BEST_EVIDENCE.txt`
