...
5. trim/realign canonical dashboards and task/status routing
6. add or refresh review metadata on touched canonical control-plane pages
7. narrow hooks to write-strict/read-loose behavior
8. encode outcome-first user reporting in AGENTS/runbooks/hooks
9. regenerate ledgers and rerun lint
