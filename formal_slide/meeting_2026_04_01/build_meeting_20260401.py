...
RECALL_SLIDES: list[dict] = [
    ...
    },
    {
        ...
        "bullets": [
            ...
            "**Controlled matrix runner:** `Newton/phystwin_bridge/tools/other/run_ground_contact_self_collision_rmse_matrix.py`.",
    ...
    },
    {
        ...
        "rows": [
            ...
            ["2x2 full-rollout gate", "reference target", "best current pair = self `phystwin` + ground `native`", "BLOCKED", "fully `phystwin` pair is still not best"],
        ],
        "transcript": [
    ...
    {
        "kind": "table_gif",
        "title": "2x2 Result: Full Rollout Matrix",
        "note": "Source paths: `docs/bridge/current_status.md`, `Newton/phystwin_bridge/tools/other/run_ground_contact_self_collision_rmse_matrix.py`, `Newton/phystwin_bridge/results/ground_contact_self_collision_rmse_matrix_20260404_140154_e11491a/rmse_matrix.csv`, `Newton/phystwin_bridge/results/ground_contact_self_collision_rmse_matrix_20260404_140154_e11491a/fairness_check.md`, `Newton/phystwin_bridge/tools/other/diagnose_controller_spring_semantics.py`.",
        "columns": ["Case", "self", "ground", "rmse_mean", "Why it matters"],
        "rows": [
            ["case 1", "off", "native", "0.0097687626", "baseline"],
            ["case 2", "off", "phystwin", "0.0096095046", "ground law helps a bit"],
            ["case 3", "phystwin", "native", "0.0087611182", "current best full-rollout pair"],
            ["case 4", "phystwin", "phystwin", "0.0090123396", "fully phystwin pair is not best"],
        ],
        "gif_path": SELF_PARITY_SUPPORT_GIF,
        "gif_label": "Case 4 support clip only",
        "transcript": [
