...
- `meeting_20260408_recall_part`
  - keep the new 2026-04-08 meeting bundle visible in the active task map; it now includes recall, rope performance profiling, stable self-collision, and conservative robot slides, and the local deck was refreshed again on `2026-04-08`
