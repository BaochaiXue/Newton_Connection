...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `docs/bridge/tasks/bunny_penetration_force_diagnostic.md` | `CANONICAL` | `ok` | `0` | `21` | `True` | `True` | `False` | `REFORMAT` |
| `docs/bridge/tasks/self_collision_transfer.md` | `CANONICAL` | `ok` | `0` | `21` | `True` | `True` | `False` | `REFORMAT` |
